...
static uri_load_dsc_t *uri_load_create_dsc( void );
static void uri_load_set_filename_from_uri( uri_load_dsc_t *uri_load_dsc, const char *uri );
static void uri_load_set_url_from_uri( uri_load_dsc_t *uri_load_dsc, const char *uri );
static uri_load_dsc_t *uri_load_file_to_ram( uri_load_dsc_t *uri_load_dsc );
static uri_load_dsc_t *uri_load_http_to_ram( uri_load_dsc_t *uri_load_dsc );
static uri_load_dsc_t *uri_load_https_to_ram( uri_load_dsc_t *uri_load_dsc );
...
uri_load_dsc_t *uri_load_http_to_ram( uri_load_dsc_t *uri_load_dsc ) {
    ...
    if ( uri_load_dsc ) {
        ...
        download_client.setUserAgent( DEVICE_NAME "-" __FIRMWARE__ );
