...
/*
        "  <div class=\"vbox\">\n"
        "    <div class=\"box\">\n"        
        "      <input type=\"checkbox\" id=\"onewire_mqtt_msg_on_change\" ><label for=\"onewire_mqtt_msg_on_change\">send onewire status on change via mqtt status</label>\n"
        "    </div>\n"
        "  </div>\n"
*/
        "  <div class=\"vbox\">\n"
        ...
        "<br>\n"
        "<br>\n"
        "<button type='button' onclick='SendSetting(\"onewire_interval\");SendSetting(\"onewire_pin\");SendCheckboxSetting(\"onewire_mqtt_msg_on_change\");SendCheckboxSetting(\"onewire_mqtt_msg_stat\");SendCheckboxSetting(\"onewire_report_in_fahrenheit\");SaveSettings();get_settings();' class='button'>save</button>";
